...
class DataStreetService:
    ...
    async def lookup_property(
        ...
        try:
            ...
            if response_data.get("status") == 404:
                return {
                    "found": False,
                    "message": response_data.get("detail", f"No property found for {address}, {postcode}"),
                    "postcode": postcode,
    ...
    def _parse_datastreet_response(self, data: Dict, postcode: str, house_number: Optional[str]) -> Dict[str, Any]:
        ...
        if sales_history:
            ...
            sorted_sales = sorted(sales_history, key=lambda x: x.get("date", ""), reverse=True)
        ...
        ordnance_survey = identities.get("ordnance_survey", {})
        ...
        return {
            ...
            "latest_sale": {
                ...
                "property_type": latest_sale.get("property_type", "") if latest_sale else "",
    ...
    def _parse_property_response(self, data: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "latest_sale": {
                "price": latest_sale.get("price") if latest_sale else None,
                "date": latest_sale.get("date") if latest_sale else None,
                "new_build": latest_sale.get("new_build", False) if latest_sale else False,
            } if latest_sale else None,
            "sales_history": [
                {
                    "price": sale.get("price"),
            ...
            "epc": data.get("epc", {}),
            "google_maps_url": self._generate_maps_url(full_address, address_parts.get("postcode", "")),
        }
...
# Singleton instance
_data_street_service: Optional[DataStreetService] = None
