...
def list_communications(
    ...
    type: str | None = Query(
        None,
        description="Filter by type (email, call, sms, note, task, meeting, viewing)",
    ),
    entity_type: str | None = Query(
        None, description="Filter by entity type (property, landlord, applicant)"
    ),
    entity_id: int | None = Query(None, description="Filter by specific entity ID"),
