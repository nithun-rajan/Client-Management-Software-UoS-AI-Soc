...
def search_buyers(
    ...
    result = []
    for buyer in buyers:
        response = ApplicantResponse.model_validate(buyer)
        result.append(add_agent_info_to_applicant_response(buyer, response, db))
    return result
...
def get_chain_free_buyers(
    ...
    result = []
    for buyer in chain_free_buyers:
        response = ApplicantResponse.model_validate(buyer)
        result.append(add_agent_info_to_applicant_response(buyer, response, db))
    return result
