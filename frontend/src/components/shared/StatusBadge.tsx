...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  viewing_booked: { label: 'Viewing Booked', className: 'bg-status-pending text-white' },
  offer_submitted: { label: 'Offer Submitted', className: 'bg-status-pending text-white' },
  offer_accepted: { label: 'Offer Accepted', className: 'bg-status-available text-white' },
