      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="shadow-card">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-primary">{kpis?.properties.total || 0}</div>
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="text-sm font-medium">Landlord Verification</CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {kpis?.landlords.aml_verified || 0} of {kpis?.landlords.total || 0} verified
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-card">
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {kpis?.applicants.qualified || 0} of {kpis?.applicants.total || 0} qualified
              </p>
            </CardContent>
          </Card>
        </div>
