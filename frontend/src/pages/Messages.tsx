...
import { Mail, Phone, MessageSquare, StickyNote, Calendar, Eye, Plus, Filter, TrendingUp } from 'lucide-react';
    ...
    <div className="p-8">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={newComm.direction} onValueChange={(value) => setNewComm({ ...newComm, direction: value })}>
                    <SelectTrigger>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">At least one entity (Property, Landlord, or Applicant) is required</p>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => setNewComm({ ...newComm, is_important: e.target.checked })}
                  className="rounded"
                />
      ...
      {stats && stats.by_entity ? (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <StatCard title="Total Communications" value={stats.total || 0} icon={MessageSquare} color="text-blue-600" />
          <StatCard title="Unread" value={stats.unread || 0} icon={Mail} color="text-orange-600" />
          <StatCard title="Important" value={stats.important || 0} icon={TrendingUp} color="text-red-600" />
          <StatCard
            title="Properties"
        ...
        <div className="text-center py-4 text-gray-500">Stats not available</div>
      )}
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-500">No communications yet. Create one to get started!</p>
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-3">
          {communications.map((comm) => {
            ...
            return (
              <Card
                key={comm.id}
                className={`${!comm.is_read ? 'border-l-4 border-l-blue-500 bg-blue-50/50' : ''} hover:shadow-md transition-shadow cursor-pointer`}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          {comm.subject && (
                            <h3 className="font-semibold text-lg mt-2">{comm.subject}</h3>
                          )}
                        </div>
                      ...
                      <div className="flex gap-4 text-sm text-gray-500">
                        ...
                        {comm.applicant_id && <span>Applicant #{comm.applicant_id}</span>}
                      </div>
                    </div>
                  </div>
                </CardContent>
