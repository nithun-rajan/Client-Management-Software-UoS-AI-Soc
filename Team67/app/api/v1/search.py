...
def search_properties(
    ...
    rent_min: Optional[float] = Query(None, description="Minimum rent"),
    rent_max: Optional[float] = Query(None, description="Maximum rent"),
    property_type: Optional[PropertyType] = Query(None, description="Property type (flat/house/maisonette)"),
    postcode: Optional[str] = Query(None, description="Postcode (partial match)"),
